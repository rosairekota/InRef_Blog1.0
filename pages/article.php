     ...
     <div class="col-lg-10 col-md-10 offset-lg-1 offset-md-1">
       <article class="mu-blog-single-item">
         ...
         <div class="mu-blog-meta">
           ...
           <a href="assets/img/articles/<?=$post->fichier_pdf?>" class="text-primary">  <strong class="text-info">Telecharger Le Fichier PDF</strong>,pour Tout lire</a>
         </div>
                    ...
                    <div class="comments">
                      <ul class="commentlist">
                        ...
                        <li>
                          <div class="media">
                            ...
                            <div class="media-body">
                             ...
                             <span class="comments-date"> Posté le <?=date("d/m/y à h:i",strtotime($cmt->date))?></span>
                             <p><?=nl2br($cmt->comment)?></p>
                             <a class="reply-btn" href="#message">Répondre <span class="fa fa-long-arrow-right"></span></a>
                            </div>
                          </div>
                        </li>
                        <?php
                        ...
                        <?php  else :?>
                              ...
                              <h3 class="text-info">Aucun commentaire n'a été publié... Soyez le Premier !</h3>
                    ...
                    <div class="row" style="background-color:none;padding:10px 10px;" id=message>
                      ...
                      <form class="form-group"  method="post" style="background-color:none;padding:50px 50px;">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 offset-lg-4 offset-md-4 offset-sm-4">
                            ...
                            <center><input type="submit" name="submit" value="commenter" class="btn btn-primary btn-block"></center>
                        </div>
          ...
          <ul class="pagination">
            <li class="active">
              <a href="?page=home#precedent" aria-label="Previous">
                <span class="fa fa-angle-left"></span> Precedent
              </a>
            </li>
            <li>
              <a href="?page=list_article" aria-label="Next">
               Suivant <span class="fa fa-angle-right"></span>
              </a>
            </li>
          </ul>
        </nav>
